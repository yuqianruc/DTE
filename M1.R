...
N=4000;d1=100;d2=100;tmax=500;K=5;M=floor(N/K)
logistic=function(x){exp(x)/(1+exp(x))}
beta_pi1_0=0
beta_pi1_S1=c(1,1,1,rep(0,d1-3))
beta_pi2_0_0=0
beta_pi2_0_S1=c(0.5,0,-0.5,rep(0,d1-3))
beta_pi2_0_S2=c(0.5,0,0.5,rep(0,d2-3))
beta_pi2_1_0=0
beta_pi2_1_S1=c(1,1,0,rep(0,d1-3))
beta_pi2_1_S2=c(1,-1,0,rep(0,d2-3))
beta_g0_0=1
beta_g0_S1=c(1,1,-1,rep(0,d1-3))
beta_g0_S2=c(1,1,1,rep(0,d2-3))
beta_g1_0=-1
beta_g1_S1=c(-1,1,-1,rep(0,d1-3))
beta_g1_S2=c(-1,-1,1,rep(0,d2-3))
set.seed(123)

S1_all=matrix(rnorm(N*d1*tmax,mean=0),nrow=N*tmax)
delta1_all=rnorm(N*tmax)
delta2_all=matrix(rnorm(N*tmax*d2),nrow=N*tmax)

pi1_all=logistic(beta_pi1_0+S1_all%*%beta_pi1_S1)
A1_all=rbinom(N*tmax,1,pi1_all)

S2_all=S1_all+matrix(rep(A1_all*(1+delta1_all),d1),nrow=N*tmax)+delta2_all
...
mu1_1_all=beta_g1_0+S1_all%*%(beta_g1_S1+beta_g1_S2)+sum(beta_g1_S2)
mu1_0_all=beta_g0_0+S1_all%*%(beta_g0_S1+beta_g0_S2)

pi2_0_all=logistic((beta_pi2_0_0+S1_all%*%beta_pi2_0_S1+S2_0_all%*%beta_pi2_0_S2))
pi2_1_all=logistic((beta_pi2_1_0+S1_all%*%beta_pi2_1_S1+S2_1_all%*%beta_pi2_1_S2))
pi2_all=logistic((1-A1_all)*(beta_pi2_0_0+S1_all%*%beta_pi2_0_S1+S2_0_all%*%beta_pi2_0_S2)+A1_all*(beta_pi2_1_0+S1_all%*%beta_pi2_1_S1+S2_1_all%*%beta_pi2_1_S2))
A2_all=rbinom(N*tmax,1,pi2_all)
g_all=(A1_all+A2_all==0)*(beta_g0_0+S1_all%*%beta_g0_S1+S2_all%*%beta_g0_S2)+(A1_all*A2_all==1)*(beta_g1_0+S1_all%*%beta_g1_S1+S2_all%*%beta_g1_S2)
zeta_all=rnorm(N*tmax)
...
mean(A1_all*A2_all)*N
mean((1-A1_all)*(1-A2_all))*N
